...
import { CheckCircle2, Film, ZapOff, UploadCloud } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[700px] bg-card border-border text-card-foreground shadow-xl rounded-lg">
        <DialogHeader className="p-6">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <DialogTitle className="text-3xl font-bold text-primary">Upgrade to VideoRevive Premium</DialogTitle>
          </div>
          <DialogDescription className="text-muted-foreground">
            Unlock powerful features and enhance your video upscaling experience to the next level.
          </DialogDescription>
        </DialogHeader>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 pb-2">
          ...
          <Card className="border-border shadow-lg hover:shadow-primary/20 transition-shadow duration-300 flex flex-col">
            ...
            <CardContent className="space-y-3 text-sm flex-grow">
              <p className="flex items-start"><CheckCircle2 className="h-5 w-5 text-green-400 mr-2 shrink-0 mt-0.5" /> Upscale videos up to 720p resolution</p>
              ...
              <p className="flex items-start"><CheckCircle2 className="h-5 w-5 text-green-400 mr-2 shrink-0 mt-0.5" /> Standard processing speed</p>
            </CardContent>
          ...
          <Card className="border-primary shadow-xl ring-2 ring-primary bg-primary/5 hover:shadow-primary/40 transition-shadow duration-300 flex flex-col">
            ...
            <CardContent className="space-y-3 text-sm flex-grow">
              <p className="flex items-start"><CheckCircle2 className="h-5 w-5 text-yellow-400 mr-2 shrink-0 mt-0.5" /> Upscale videos up to 1080p HD</p>
              ...
              <p className="flex items-start"><Film className="h-5 w-5 text-yellow-400 mr-2 shrink-0 mt-0.5" /> Highest quality AI processing</p>
              <p className="flex items-start"><CheckCircle2 className="h-5 w-5 text-yellow-400 mr-2 shrink-0 mt-0.5" /> Priority processing queue</p>
            </CardContent>
            <CardFooter className="mt-auto pt-4">
